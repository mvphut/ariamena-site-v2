export const site = {
  ...
  ui: {
    ...
    cookie: {
      ...
      text: "This site sets no tracking cookies. Page views are counted by cookieless analytics that cannot identify you. Essential storage only remembers that you have seen this notice.",
      link: "Privacy notice",
      essential: "Essential",
      essentialNote: "Remembers your choice. Always on.",
      analytics: "Analytics",
      analyticsNote: "Cloudflare Web Analytics: anonymous page counts, no cookies, no personal data, always on.",
      save: "Save preferences",
      onlyEssential: "Got it",
