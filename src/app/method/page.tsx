...
import { howPrograms, methodPage, methodStages } from "@/content/site";
      ...
      <section className={p.section} data-theme-section="light">
        <div className="container">
          <div className={p.head}>
            ...
            <p>Four weeks from first call to delivered data. Sized to prove quality against your own benchmarks before anyone commits to scale.</p>
          </div>
          <div className={p.timeline}>
      ...
      <section className={`${p.section} ${p.sectionMineral}`} data-theme-section="light">
        <div className="container">
          <div className={p.head}>
            ...
            <p>Three shapes of engagement. Every one starts with written acceptance criteria and ends with a documented delivery.</p>
          </div>
          <div className={p.grid3}>
