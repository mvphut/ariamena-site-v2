...
export function ResponsibleView({ c }: { c: Content }) {
  const { principles, responsiblePage, security, site } = c;
  return (
    <>
      <PageHero eyebrow={responsiblePage.hero.eyebrow} title={responsiblePage.hero.title} lead={responsiblePage.hero.lead} accent={responsiblePage.hero.accent} />
      <section className={`${p.section} ${p.sectionCool}`} data-theme-section="cool">
        <div className="container">
          <div className={p.head}>
            <h2>{site.ui.sixPrinciples}</h2>
            <p>{site.ui.sixBody}</p>
          </div>
      ...
      <section className={p.section} data-theme-section="light">
        <div className="container">
          <div className={p.head}>
            <h2>{site.ui.inPractice}</h2>
            <p>{site.ui.inPracticeBody}</p>
          </div>
